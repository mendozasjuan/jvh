      ...
      <div class="row mt-5">
        ...
        <div class="row mt-5">
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Pagina Calidad</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" @submit.prevent="updateCalidad" enctype="multipart/form-data" id='form'>
                <div class="card-body">
                  ...
                  <div class="form-group">
                        ...
                        <input v-model="form.texto_encabezado_en" type="text" class="form-control" placeholder="Ingrese el Texto" name="texto_encabezado_en" :class="{ 'is-invalid': form.errors.has('texto_encabezado_en') }">
                        <!--<textarea v-model="form.texto_encabezado" class="form-control" rows="3" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('texto_encabezado') }"></textarea>-->
                        <!--<ckeditor class="col-md-10 form-control" :class="{ 'is-invalid': form.errors.has('texto_encabezado') }" tag-name="textarea"  :editor="editor" v-model="form.texto_encabezado" :config="editorConfig"></ckeditor>-->
                  ...
                  <div class="form-group">
                        ...
                        <input v-model="form.seccion1_titulo_en" type="text" class="form-control" placeholder="Ingrese el Titulo" name="seccion1_titulo_en" :class="{ 'is-invalid': form.errors.has('seccion1_titulo_en') }">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" lang="es" class="custom-file-input" id="seccion1_logo4" name="seccion1_logo4" v-on:change="onUploadImage">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" lang="es" class="custom-file-input" id="seccion1_logo5" name="seccion1_logo5" v-on:change="onUploadImage">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" lang="es" class="custom-file-input" id="seccion1_logo6" name="seccion1_logo6" v-on:change="onUploadImage">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" lang="es" class="custom-file-input" id="seccion1_logo7" name="seccion1_logo7" v-on:change="onUploadImage">
                  ...
                  <div class="modal-content">
                    ...
                    <form @submit.prevent="createSlider" enctype="multipart/form-data" id='formulario'>
                      ...
                      <div class="modal-body">
                        ...
                        <input type="hidden" v-model="form.id" name="calidad_id">
                      </div>
  ...
  import ClassicEditor from '@ckeditor/ckeditor5-build-classic';
    export default {
        ...
        editWindow(calidad){
            ...
            this.form.texto_encabezado_en= typeof calidad.texto_encabezado === 'object' ? calidad.texto_encabezado.en : '';
            ...
            this.form.seccion1_titulo_en= typeof calidad.seccion1_titulo === 'object' ? calidad.seccion1_titulo.en : '';
            this.form.seccion1_parrafo_en= typeof calidad.seccion1_parrafo === 'object' ? calidad.seccion1_parrafo.en : '';
        ...
        loadCalidad() {
          ...
          axios.get("api/calidad").then( data => (this.editWindow(data.data)));
        ...
        onUploadImage: function (event){
          if (event) {
            ...
            if (this.picFile) {
              ...
              if(this.idElement.id == 'seccion1_logo4'){
                this.form.seccion1_logo4 = this.picFile
                console.log(this.form.seccion1_logo4);
              }

              if(this.idElement.id == 'seccion1_logo5'){
                this.form.seccion1_logo5 = this.picFile
                console.log(this.form.seccion1_logo5);
              }

              if(this.idElement.id == 'seccion1_logo6'){
                this.form.seccion1_logo6 = this.picFile
                console.log(this.form.seccion1_logo6);
              }

              if(this.idElement.id == 'seccion1_logo7'){
                this.form.seccion1_logo7 = this.picFile
                console.log(this.form.seccion1_logo7);
              }
        ...
        createCalidad(event){
          ...
          createSlider(event){
            ...
            axios.post('api/slidercalidad',formData)
            .then((data) => {
              console.log(data);
              Toast.fire({
                icon: 'success',
          ...
          if(!this.editSliderMode)
           ...
           let formData =  new FormData(event.target)
            ...
            formData.append('texto_en',this.slider.texto_en);
             formData.append('_method', 'PUT');
            //this.form.submit('put','api/inicio/'+this.form.id,{
              axios.post('api/slidercalidad/'+this.slider.id,formData)
               .then(()=>{
                  this.loadSliders();
        ...
        loadSliders() {
          ...
          axios.get("api/allslidercalidad/"+this.form.id).then( (data) => {
            console.log(data);
        ...
        deleteSlider(sliderid){
          Swal.fire({
              ...
              if (result.value) {
                this.$Progress.start()
                axios.delete('api/slidercalidad/'+sliderid)
                .then((data) => {
                  console.log(data);
                  Toast.fire({
                    icon: 'success',
        ...
        created() { 
            this.loadCalidad();
            Fire.$on('AfterCreatedCalidadLoadIt',()=>{ //custom events fire on
                this.loadCalidad();
