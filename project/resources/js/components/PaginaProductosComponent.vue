              ...
              <form role="form" @submit.prevent="updatePaginaProductos" enctype="multipart/form-data" id='form'>
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="file" lang="es" class="custom-file-input" id="seccion1_imagen_fondo" name="seccion1_imagen_fondo" v-on:change="onUploadImage">
                  ...
                  <div class="modal-content">
                    ...
                    <form @submit.prevent="createSlider" enctype="multipart/form-data" id='formulario'>
                      ...
                      <div class="modal-body">
                        ...
                        <input type="hidden" v-model="form.id" name="pagina_productos_id">
                      </div>
  ...
  import ClassicEditor from '@ckeditor/ckeditor5-build-classic';
    export default {
        ...
        editWindow(paginaproductos){
            ...
            this.form.seccion1_titulo_en= typeof paginaproductos.seccion1_titulo === 'object' ? paginaproductos.seccion1_titulo.en : '';
            ...
            this.sliders = paginaproductos.sliders;
        	}
        ...
        createPaginaProductos(event){
          ...
          axios.post('api/sliderproductos',formData)
          .then((data) => {
            console.log(data);
            Toast.fire({
              icon: 'success',
          ...
          if(!this.editSliderMode)
           ...
           let formData =  new FormData(event.target)
            ...
            formData.append('texto_en',this.slider.texto_en);
             formData.append('_method', 'PUT');
            //this.form.submit('put','api/inicio/'+this.form.id,{
              axios.post('api/sliderproductos/'+this.slider.id,formData)
               .then(()=>{
                  this.loadSliders();
        ...
        loadSliders() {
          ...
          axios.get("api/allsliderproductos/"+this.form.id).then( (data) => {
            console.log(data);
        ...
        deleteSlider(sliderid){
          Swal.fire({
              ...
              if (result.value) {
                this.$Progress.start()
                axios.delete('api/sliderproductos/'+sliderid)
                .then((data) => {
                  console.log(data);
                  Toast.fire({
                    icon: 'success',
