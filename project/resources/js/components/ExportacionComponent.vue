      ...
      <div class="row mt-5">
        ...
        <div class="row mt-5">
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Pagina Exportacion</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" @submit.prevent="updateExportacion" enctype="multipart/form-data" id='form'>
                <div class="card-body">
                  <h3>Encabezado</h3>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" lang="es" class="custom-file-input" id="seccion1_imagen" name="seccion1_imagen" v-on:change="onUploadImage">
                        <label class="custom-file-label" for="seccion1_imagen">Seleccione Archivo</label>
                      </div>
                      <div class="input-group-append">
                        <span class="input-group-text" id="">Subir</span>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="seccion2_imagen_fondo">Seleccione Archivo</label>
                      </div>
                      <div class="input-group-append">
                        <span class="input-group-text" id="">Subir</span>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" lang="es" class="custom-file-input" id="seccion3_imagen_fondo" name="seccion3_imagen_fondo" v-on:change="onUploadImage">
                  ...
                  <div class="modal-content">
                    ...
                    <form @submit.prevent="createSlider" enctype="multipart/form-data" id='formulario'>
                      ...
                      <div class="modal-body">
                        ...
                        <input type="hidden" v-model="form.id" name="exportacion_id">
                      </div>
...
<script>
  import ClassicEditor from '@ckeditor/ckeditor5-build-classic';
    export default {
        ...
        editWindow(exportacion){
        	if(exportacion){
        		this.editMode = true
    				this.form.clear();				
    				this.form.reset();

    				this.form.id= exportacion.id;
    				this.form.encabezado_imagen_fondo = exportacion.encabezado_imagen_fondo;
    				this.form.logo_1_encabezado= exportacion.logo_1_encabezado;
    				this.form.logo_2_encabezado= exportacion.logo_2_encabezado;

    				this.form.texto_encabezado= typeof exportacion.texto_encabezado === 'object' ? exportacion.texto_encabezado.es : '';
    				this.form.texto_encabezado_zh= typeof exportacion.texto_encabezado === 'object' ? exportacion.texto_encabezado.zh : '';
            this.form.texto_encabezado_en= typeof exportacion.texto_encabezado === 'object' ? exportacion.texto_encabezado.en : '';
            ...
            this.form.seccion1_titulo_en = typeof exportacion.seccion1_titulo === 'object' ? exportacion.seccion1_titulo.en : '';
            this.form.seccion1_parrafo_en = typeof exportacion.seccion1_parrafo === 'object' ? exportacion.seccion1_parrafo.en : '';
            ...
            this.form.seccion2_parrafo1_en = typeof exportacion.seccion2_parrafo1 === 'object' ? exportacion.seccion2_parrafo1.en : '';
            this.form.seccion2_parrafo2_en = typeof exportacion.seccion2_parrafo2 === 'object' ? exportacion.seccion2_parrafo2.en : '';
            ...
            this.form.seccion3_titulo_zh = typeof exportacion.seccion3_titulo === 'object' ? exportacion.seccion3_titulo.zh : '';
             this.form.seccion3_titulo_en = typeof exportacion.seccion3_titulo === 'object' ? exportacion.seccion3_titulo.en : '';
            ...
            this.sliders = exportacion.sliders;
        	}
        },
        openModalWindow(){
        ...
        loadExportacion() {
          ...
          axios.get("api/exportacion").then( data => (this.editWindow(data.data)));
        
          //pick data from controller and push it into users object

        },
        updateExportacion(event){
        	if(!this.editMode)
	        	return this.createExportacion(event);
           ...
           let formData =  new FormData(event.target)
            ...
            //this.form.submit('put','api/inicio/'+this.form.id,{
              axios.post('api/exportacion/'+this.form.id,formData)
               .then(()=>{
                  Fire.$emit('AfterCreatedExportacionLoadIt');

                   Toast.fire({
                      icon: 'success',
                      title: 'Pagina Exportacion Actualizada con Exito'
                    })
        ...
        createExportacion(event){
            ...
            formData.append('seccion2_parrafo2_en',this.form.seccion2_parrafo2_en);
             ...
             axios.post('api/exportacion',formData)
                .then(() => {
                    ...
                    Fire.$emit('AfterCreatedExportacionLoadIt'); //custom events
          ...
          axios.post('api/sliderexportacion',formData)
          .then((data) => {
            console.log(data);
            Toast.fire({
              icon: 'success',
          ...
          if(!this.editSliderMode)
           ...
           let formData =  new FormData(event.target)
            ...
            formData.append('texto_en',this.slider.texto_en);
             formData.append('_method', 'PUT');
            //this.form.submit('put','api/inicio/'+this.form.id,{
              axios.post('api/sliderexportacion/'+this.slider.id,formData)
               .then(()=>{
                  this.loadSliders();
        ...
        loadSliders() {
          ...
          axios.get("api/allsliderexportacion/"+this.form.id).then( (data) => {
            console.log(data);
        ...
        deleteSlider(sliderid){
          Swal.fire({
              ...
              if (result.value) {
                this.$Progress.start()
                axios.delete('api/sliderexportacion/'+sliderid)
                .then((data) => {
                  console.log(data);
                  Toast.fire({
                    icon: 'success',
        ...
        created() { 
            this.loadExportacion();
            Fire.$on('AfterCreatedExportacionLoadIt',()=>{ //custom events fire on
                this.loadExportacion();
