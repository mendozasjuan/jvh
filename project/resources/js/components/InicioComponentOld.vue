              ...
              <form role="form" @submit.prevent="editMode ? updateInicio() : createInicio()" enctype="multipart/form-data" id='form'>
                <div class="card-body">
                  ...
                  <div class="form-group">
                        ...
                        <input v-model="form.texto_encabezado.es" type="text" class="form-control" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('texto_encabezado') }">
                        <has-error :form="form" field="texto_encabezado"></has-error>
                  </div>
                  <div class="form-group">
                        <label>Texto (Chino)</label>
                        <!--<textarea v-model="form.texto_encabezado" class="form-control" rows="3" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('texto_encabezado') }"></textarea>-->
                        <input v-model="form.texto_encabezado.zh" type="text" class="form-control" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('texto_encabezado') }">
                        <has-error :form="form" field="texto_encabezado"></has-error>
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <input v-model="form.seccion1_titulo.es" type="text" class="form-control" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('seccion1_titulo') }">
                        <has-error :form="form" field="seccion1_titulo"></has-error>
                  </div>
                  <div class="form-group">
                        <label>Titulo (Chino)</label>
                        <input v-model="form.seccion1_titulo.zh" type="text" class="form-control" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('seccion1_titulo') }">
                        <has-error :form="form" field="seccion1_titulo"></has-error>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                        ...
                        <!--<textarea v-model="form.seccion_1_parrafo" class="form-control" rows="3" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('seccion_1_parrafo') }"></textarea>-->
                        <ckeditor class="col-md-10 form-control" :class="{ 'is-invalid': form.errors.has('seccion_1_parrafo') }" tag-name="textarea" name="seccion_1_parrafo.zh" :editor="editor" v-model="form.seccion_1_parrafo.zh" :config="editorConfig"></ckeditor>
                        <has-error :form="form" field="seccion_1_parrafo"></has-error>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                        <label>Titulo (Español)</label>
                        <input v-model="form.seccio2_titulo.es" type="text" class="form-control" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('seccio2_titulo') }">
                        <has-error :form="form" field="seccio2_titulo"></has-error>
                  </div>
                   <div class="form-group">
                        <label>Titulo (Chino)</label>
                        <input v-model="form.seccio2_titulo.zh" type="text" class="form-control" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('seccio2_titulo') }">
                        <has-error :form="form" field="seccio2_titulo"></has-error>
                  </div>
                  <div class="form-group">
                        <label>Parrafo (Español)</label>
                        ...
                        <ckeditor class="col-md-10 form-control" :class="{ 'is-invalid': form.errors.has('seccion_2_parrafo') }" tag-name="textarea" name="seccion_2_parrafo.es" :editor="editor" v-model="form.seccion_2_parrafo.es" :config="editorConfig"></ckeditor>
                        <has-error :form="form" field="seccion_2_parrafo"></has-error>
                  </div>
                  <div class="form-group">
                        <label>Parrafo (Chino)</label>
                        <!--<textarea v-model="form.seccion_2_parrafo" class="form-control" rows="3" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('seccion_2_parrafo') }"></textarea>-->
                        <ckeditor class="col-md-10 form-control" :class="{ 'is-invalid': form.errors.has('seccion_2_parrafo') }" tag-name="textarea" name="seccion_2_parrafo.zh" :editor="editor" v-model="form.seccion_2_parrafo.zh" :config="editorConfig"></ckeditor>
                        <has-error :form="form" field="seccion_2_parrafo"></has-error>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                        <label>Titulo (Español)</label>
                        <input v-model="form.seccion3_titulo.es" type="text" class="form-control" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('seccion3_titulo') }">
                        <has-error :form="form" field="seccion3_titulo"></has-error>
                  </div>
                  <div class="form-group">
                        <label>Titulo (Chino)</label>
                        <input v-model="form.seccion3_titulo.zh" type="text" class="form-control" placeholder="Enter ..." :class="{ 'is-invalid': form.errors.has('seccion3_titulo') }">
                        <has-error :form="form" field="seccion3_titulo"></has-error>
                  </div>
                  <div class="form-group">
                        <label>Parrafo (Español)</label>
                        ...
                        <ckeditor class="col-md-10 form-control" :class="{ 'is-invalid': form.errors.has('seccion3_parrafo') }" tag-name="textarea" name="seccion3_parrafo.es" :editor="editor" v-model="form.seccion3_parrafo.es" :config="editorConfig"></ckeditor>
                        <has-error :form="form" field="seccion3_parrafo"></has-error>
                  </div>
                  <div class="form-group">
                        <label>Parrafo (Chino)</label>
                        <!--<textarea v-model="form.seccion3_parrafo" :class="{ 'is-invalid': form.errors.has('seccion3_parrafo') }" class="form-control" rows="3" placeholder="Enter ..."></textarea>-->
                        <ckeditor class="col-md-10 form-control" :class="{ 'is-invalid': form.errors.has('seccion3_parrafo') }" tag-name="textarea" name="seccion3_parrafo.zh" :editor="editor" v-model="form.seccion3_parrafo.zh" :config="editorConfig"></ckeditor>
                        <has-error :form="form" field="seccion3_parrafo"></has-error>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                        <label>Titulo (Español)</label>
                        <input v-model="form.seccion4_titulo.es" :class="{ 'is-invalid': form.errors.has('seccion4_titulo') }" type="text" class="form-control" placeholder="Enter ...">
                        <has-error :form="form" field="seccion4_titulo"></has-error>
                  </div>
                  <div class="form-group">
                        <label>Titulo (Chino)</label>
                        <input v-model="form.seccion4_titulo.zh" :class="{ 'is-invalid': form.errors.has('seccion4_titulo') }" type="text" class="form-control" placeholder="Enter ...">
                        <has-error :form="form" field="seccion4_titulo"></has-error>
                  </div>
                  <div class="form-group">
        ...
        data() {
            return {
                ...
                form: new Form({
                    ...
                    logo_1_encabezado: '',
                    logo_2_encabezado: '',
                    texto_encabezado:{es:'',zh:''},
                    texto_encabezado_habilitado: false,
                    seccion1_titulo: {es:'',zh:''},
                    seccion_1_parrafo: {es:'',zh:''},
                    seccion1_logo1: '',
                    seccion1_logo2: '',
                    seccion1_logo3: '',
                    seccion2_imagen_fondo:'',
                    seccio2_titulo:{es:'',zh:''},
                    seccion_2_parrafo: {es:'',zh:''},
                    seccion3_titulo: {es:'',zh:''},
                    seccion3_parrafo: {es:'',zh:''},
                    seccion3_imagen: '',
