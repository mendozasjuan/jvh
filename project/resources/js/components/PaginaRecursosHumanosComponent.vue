                  ...
                  <div class="modal-content">
                    ...
                    <form @submit.prevent="createSlider" enctype="multipart/form-data" id='formulario'>
                      ...
                      <div class="modal-body">
                        ...
                        <input type="hidden" v-model="form.id" name="pagina_recursos_humanos_id">
                      </div>
  ...
  import ClassicEditor from '@ckeditor/ckeditor5-build-classic';
    export default {
        ...
        editWindow(paginarecursoshumanos){
            ...
            this.form.seccion1_titulo_en= typeof paginarecursoshumanos.seccion1_titulo === 'object' ? paginarecursoshumanos.seccion1_titulo.en : '';
            ...
            this.form.seccion1_parrafo_en= typeof paginarecursoshumanos.seccion1_parrafo === 'object' ? paginarecursoshumanos.seccion1_parrafo.en : '';

            this.sliders = paginarecursoshumanos.sliders;
        ...
        createPaginaRecursosHumanos(event){
          ...
          createSlider(event){
            ...
            axios.post('api/sliderrecursoshumanos',formData)
            .then((data) => {
              console.log(data);
              Toast.fire({
                icon: 'success',
          ...
          if(!this.editSliderMode)
           ...
           let formData =  new FormData(event.target)
            ...
            formData.append('texto_en',this.slider.texto_en);
             formData.append('_method', 'PUT');
            //this.form.submit('put','api/inicio/'+this.form.id,{
              axios.post('api/sliderrecursoshumanos/'+this.slider.id,formData)
               .then(()=>{
                  this.loadSliders();
        ...
        loadSliders() {
          ...
          axios.get("api/allsliderrecursoshumanos/"+this.form.id).then( (data) => {
            console.log(data);
        ...
        deleteSlider(sliderid){
          Swal.fire({
              ...
              if (result.value) {
                this.$Progress.start()
                axios.delete('api/sliderrecursoshumanos/'+sliderid)
                .then((data) => {
                  console.log(data);
                  Toast.fire({
                    icon: 'success',
