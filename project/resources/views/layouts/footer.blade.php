						...
						<div class="row" style="margin-bottom: 15px;font-size: 13px;font-weight: 400;">
							...
							<div class="col">
								<div class="row">
									...
									<div>
										<span style="font-weight: bold;">Comercio Exterior</span> <br><span style="color:#fff">{!! $footer->comercio_exterior !!}<!--Jescudero@frigorificohv.com.ar--></span>
									</div>
								</div>
							</div>
						</div>
						<div class="row" style="font-size: 13px;font-weight: 400;">
							...
							<div class="col">
								<div class="row">
									...
									<div>
										<span style="font-weight: bold;">Área Comercial</span> <br><span style="color:#fff">
