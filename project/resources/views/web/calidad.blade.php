...
@section('estilos')
	<style>
		.hero-img{
			height: 600px;
			width: 100%;
			background: url("{{ asset('img/34eddf_a08e0859269446e3bbc91d36c238e3af_mv2.png') }}") no-repeat center center;
		...
		#c-seccion3{
			height: 450px;
			background: transparent url("{{ asset('img/15.png') }}") no-repeat center center;
			opacity:1;
			color:#fff;
			padding-right: 38px;
			background-size: cover;
